  ...
  return (
    <footer className=" overflow-hidden bg-gray-800 px-6  py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="max-w-screen-xl px-4 mx-auto">
        ...
        <div className="pt-8 flex max-w-xs mx-auto items-center justify-between">
          ...
          >
            <svg
              ...
              height="30"
              fill="currentColor"
              className="text-xl transition-colors duration-200  dark:hover:text-white"
        ...
        <div className="max-w-sm h-0.5 mx-auto bg-gray-400 my-5" />
        <div className="text-center text-gray-500 dark:text-gray-200 pt-2 sm:pt-2 font-light flex items-center justify-center">
          Created by <span className="ml-2 text-green-500">JGRL</span>
        </div>
      </div>
    </footer>
  );
